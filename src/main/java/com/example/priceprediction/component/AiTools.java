...
public class AiTools {
    ...
    public String getItemPriceData(@P("Standard numeric itemId from cs_qaq_item_id, for example 6558.") String itemId) {
        return observationFormatter.toJson(toolExecutor.execute(new ToolCallRequest(
                null,
                "getItemPriceData",
    ...
    public String runItemStrategyAnalysis(@P("Standard numeric itemId from cs_qaq_item_id, for example 6558.") String itemId) {
        return observationFormatter.toJson(toolExecutor.execute(new ToolCallRequest(
                null,
